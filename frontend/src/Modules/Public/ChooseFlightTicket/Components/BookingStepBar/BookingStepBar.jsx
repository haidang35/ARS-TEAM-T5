            ...
            <div className="row">
              <div className="col-md-3">
                ...
                >
                  ...
                  <Typography className="title"> Select flight</Typography>
                </div>
              </div>
              <div className="col-md-3">
                <div
                ...
                >
                  ...
                  <Typography className="title"> Reservation</Typography>
                </div>
              </div>
              <div className="col-md-3">
                <div
                ...
                >
                  ...
                  <Typography className="title"> Bonus Services</Typography>
                </div>
              </div>
              <div className="col-md-3">
                <div
