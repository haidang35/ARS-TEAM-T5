...
class UpdateLocation extends Form {
    ...
    getLocationDetails = async () => {
        ...
        console.log("2222", id);
        await locationsService.getLocationDetail(id).then((res) => {
            const data = res.data;
            ...
            locationsService.getCitiesByProvince(data.City.ProvinceId)
                .then((res) => {
                    this.setState({
                        cityList: res.data
                    })
                ...
                <React.Fragment>
                    <div id='updateLocation'>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <div id='submit'>
                                <Button variant="contained" onClick={this.onUpdateLocation} >Update</Button>
                            </div>
                        </Grid>
                    </div>
                </React.Fragment>
